...
String OPEN_WEATHER_MAP_APP_ID = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
...
void drawDateTime(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y) {
  ...
  display->setFont(ArialMT_Plain_10);
  display->setTextAlignment(TEXT_ALIGN_LEFT);
  String HomePres = String(lux) + " lux";
  display->drawString(40 + x, 38 + y, HomePres);
}
...
void drawCurrentWeather(OLEDDisplay *display, OLEDDisplayUiState* state, int16_t x, int16_t y) {
  ...
  display->setFont(ArialMT_Plain_10);
  display->setTextAlignment(TEXT_ALIGN_LEFT);
  String HomePres = String(p) + "Pa";
  display->drawString(63 + x, 28 + y, HomePres);
...
void drawHeaderOverlay(OLEDDisplay *display, OLEDDisplayUiState* state) {
  ...
  String temp = String(currentWeather.temp, 1) + (IS_METRIC ? "°C" : "°F");
  String tempHome = String(t) + "°C " + String(h) + "%";
  display->drawString(128, 54, tempHome);
